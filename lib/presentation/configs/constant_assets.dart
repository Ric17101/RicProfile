...
const String kaMe = "$basePath$mePath/me.png";
...
const String kaFlutterIcon = "$basePath$projectPath/flutter.png";
const String kaImow = "$basePath$projectPath/imow.png";
const String kaSproutHr = "$basePath$projectPath/sprout-hr.png";
...
const String kaAndroid = "$basePath$toolsPath/android.svg";
